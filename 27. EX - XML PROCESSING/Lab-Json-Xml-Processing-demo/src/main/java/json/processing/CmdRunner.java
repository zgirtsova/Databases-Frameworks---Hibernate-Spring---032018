...
import json.processing.parser.Parser;
...
public class CmdRunner implements CommandLineRunner {
    ...
    private final Parser serializerJson;
    private final Parser serializerXml;

    private PersonService personService;

    @Autowired
    public CmdRunner(PersonService personService,
                     @Qualifier(value = "XmlParser") Parser serializerXml,
                     @Qualifier(value = "JsonParser") Parser serializerJson) {
