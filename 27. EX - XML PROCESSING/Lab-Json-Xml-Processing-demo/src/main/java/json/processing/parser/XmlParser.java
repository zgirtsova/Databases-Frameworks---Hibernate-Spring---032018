...
import json.processing.parser.exeptions.SerializeExeption;
...
public class XmlParser implements Parser {
    ...
    public <T> void serialize(T t, String fileName) {
        try {
            ...
            //log here...
            throw  new SerializeExeption("Could not parser " + t + "! ", e);
        } catch (IOException ioe) {
            //log here...
            throw  new SerializeExeption("Could not parser " + t + "! Unable to write file" + fileName + "!", ioe);
        }
    }
